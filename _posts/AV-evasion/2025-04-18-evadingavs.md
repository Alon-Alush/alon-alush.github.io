...
![Video results for searching "FUD Crypter" on Youtube](/assets/images/unpacking/evadingavs/videos.png)

![FUD crypter marketplace on Telegram](/assets/images/unpacking/evadingavs/marketplace.png)

And here's an example of how one of these FUD crypters look like:

![Video results for searching "FUD Crypter" on Youtube](/assets/images/unpacking/evadingavs/crypter.png)
...
![Direct WinAPI function usage](/assets/images/unpacking/evadingavs/crypter.png)
...
![Custom WinAPI function implementation](/assets/images/unpacking/evadingavs/customfunction.png)
...
These custom functions reduced the detections of my packer to 

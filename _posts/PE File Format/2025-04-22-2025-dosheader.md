...
Can see you see the `PE` signature, highlighted in red? it marks the start of the **IMAGE_NT_HEADERS** structure,  a Windows uses `e_lfanew` to find that structure.
